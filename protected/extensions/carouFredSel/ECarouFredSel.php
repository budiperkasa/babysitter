...
class ECarouFredSel extends CWidget
{
	...
	// @ array of config settings for Carouselfred
	public $config=array();
	...
	public function publishAssets()
	{
		...
		if(is_dir($assets)){
			...
			Yii::app()->clientScript->registerScriptFile($baseUrl . '/jquery.carouFredSel-6.2.1-packed.js', CClientScript::POS_HEAD);
			Yii::app()->clientScript->registerScriptFile($baseUrl . '/maskImage.js', CClientScript::POS_HEAD);
		} else {
